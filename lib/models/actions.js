					...
					if (!action) {
						...
						that.searchOne({ id: action.id }).then(function(action) {
							...
							if (!action.after) {
								...
								_container.get("scenarios").deleteJunction(action.after).then(function() {
