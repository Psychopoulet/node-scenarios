...
CREATE TABLE IF NOT EXISTS conditions (
	...
	id_onyes INTEGER NOT NULL,
	id_onno INTEGER NOT NULL,
	id_type INTEGER NOT NULL,

	FOREIGN KEY (id_onyes) REFERENCES junctions(id) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (id_onno) REFERENCES junctions(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS junctions (
	...
	FOREIGN KEY (id_action) REFERENCES actions(id) ON DELETE SET NULL ON UPDATE CASCADE,
	FOREIGN KEY (id_condition) REFERENCES conditions(id) ON DELETE SET NULL ON UPDATE CASCADE
